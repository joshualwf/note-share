              ...
              <Card className="mx-auto w-full p-6">
                <div className="mb-6 flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground text-start">
                    ...
                    resulting from your use of the platform. You use the
                    platform at your own risk. This is a side project run in
                    good faith to help students. We do not moderate or verify
                    uploaded content. <br />
                    <br />
                    2. User Responsibilities You agree: To only upload content
                    you have the right to share. Not to post any content that
                    ...
                    <br />
                    <br />
                    5. Intellectual Property & Takedown Policy If you believe
                    your copyrighted material is being shared unlawfully,
                    contact us at{" "}
                    <a
                    ...
                    these Terms from time to time Remove content at our
                    discretion Suspend or terminate accounts that violate these
                    Terms
                    <br />
                    <br />
