...
async function main() {
  await prisma.school.createMany({
    data: [
        ...
        {name: 'Singapore University of Technology and Design', type: 'university'},
        ...
        {name: 'Anglo-Chinese School (Junior) - Boys only, Affiliated', type: 'primary'},
        {name: 'Anglo-Chinese School (Primary) - Boys only, Affiliated', type: 'primary'},
        ...
        {name: 'CHIJ (Katong) Primary - Girls only, Affiliated', type: 'primary'},
        {name: 'CHIJ (Kellock) - Girls only, Affiliated', type: 'primary'},
        {name: 'CHIJ Our Lady of Good Counsel - Girls only, Affiliated', type: 'primary'},
        {name: 'CHIJ Our Lady of the Nativity - Girls only, Affiliated', type: 'primary'},
        {name: 'CHIJ Our Lady Queen of Peace - Girls only, Affiliated', type: 'primary'},
        {name: 'CHIJ Primary (Toa Payoh) - Girls only, Affiliated', type: 'primary'},
        {name: "CHIJ St. Nicholas Girls' School - Girls only, Affiliated", type: 'primary'},
        ...
        {name: 'Fairfield Methodist School (Primary) - Affiliated', type: 'primary'},
        ...
        {name: 'Geylang Methodist School (Primary) - Affiliated', type: 'primary'},
        ...
        {name: 'Kuo Chuan Presbyterian Primary School - Affiliated', type: 'primary'},
        ...
        {name: 'Maris Stella High School - Boys only, Affiliated', type: 'primary'},
        ...
        {name: "Methodist Girls' School (Primary) - Girls only, Affiliated", type: 'primary'},
        {name: 'Montfort Junior School - Boys only, Affiliated', type: 'primary'},
        ...
        {name: "Paya Lebar Methodist Girls' School (Primary) - Girls only, Affiliated", type: 'primary'},
        ...
        {name: "Singapore Chinese Girls' Primary School - Girls only, Affiliated", type: 'primary'},
        {name: 'South View Primary School', type: 'primary'},
        {name: 'Springdale Primary School', type: 'primary'},
        {name: "St. Andrew's Junior School - Boys only, Affiliated", type: 'primary'},
        {name: "St. Anthony's Canossian Primary School - Girls only, Affiliated", type: 'primary'},
        {name: "St. Anthony's Primary School - Affiliated", type: 'primary'},
        {name: "St. Gabriel's Primary School - Boys only, Affiliated", type: 'primary'},
        {name: "St. Hilda's Primary School - Affiliated", type: 'primary'},
        {name: "St. Joseph's Institution Junior - Boys only, Affiliated", type: 'primary'},
        {name: "St. Margaret's School (Primary) - Girls only, Affiliated", type: 'primary'},
  ...
  await prisma.course.createMany({
    data: [
      {schoolName: 'National University of Singapore', courseCode: 'CS1001'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1002'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1003'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1004'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1005'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1006'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1007'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1008'},
      {schoolName: 'National University of Singapore', courseCode: 'CS1009'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1001'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1002'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1003'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1004', courseName: 'Linear Algebra for Computing'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1005', courseName: 'Digital Logic'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1006', courseName: 'Computer Organisation & Architecture'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1007'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1008'},
      {schoolName: 'Nanyang Technological University', courseCode: 'SC1009'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1001'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1002'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1003'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1004'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1005'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1006'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1007'},
      {schoolName: 'Singapore Management University', courseCode: 'COR1008'},
    ],
    skipDuplicates: true, // avoid errors on rerun
  });
}
